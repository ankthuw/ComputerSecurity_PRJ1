...
class RegisterLoginFrame(tk.Frame):
    ...
    def register_view(self):
        ...
        def submit():
            ...
            # Nếu đăng ký thành công -> hiển thị mã khôi phục
            if ok:
                recovery_key = msg
                ...
                messagebox.showinfo("Đăng ký thành công", "Tài khoản đã được đăng ký thành công!")
                win.destroy()
            # Nếu thất bại -> Hiện lỗi và yêu cầu đăng ký lại
            else:
