...
from modules.session import get_email, get_passphrase # lấy email và passphrase từ người dùng hiện tại
...
def renew_key(email):
    ''' 
        Gia hạn khóa RSA cho người dùng
    '''
    ...
    try:
        ...
        # Lấy passphrase của người dùng hiện tại
        ...
        write_log(email, "RSA", "Gia hạn thất bại - Sai passphrase: " + str(e))
